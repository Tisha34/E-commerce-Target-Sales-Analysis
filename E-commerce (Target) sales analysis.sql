...
(select o.customer_id,o.order_id,count(i.order_id) as OC 
from orders as o join order_items as i 
...
over (order by years,month_num) as Cumulative_sales
from
...
group by years,months, month_num ) as a;
